...
def calculate_water_pressure(s_p, data, i):
    ...
    # Add the output to the water pressure list
    data.water_pressure.append(output)
...
def calculate_vertical_normal_stress(s_p, data, i):
    ...
    if i is not 0:
        output[0] = data.vertical_normal_stress.list[i - 1][1]
    ...
    data.vertical_normal_stress.append(output)
...
def calculate_horizontal_normal_stress(s_p, data, i):
    ...
    # Calculate the vertical normal stress for the bottom and top level
    # Top
    output[0] = data.effective_horizontal_normal_stress.list[i][0] + data.water_pressure.list[i][0]
    # Bottom
    output[1] = data.effective_horizontal_normal_stress.list[i][1] + data.water_pressure.list[i][1]
    # Add the output to the horizontal normal stress list
    data.horizontal_normal_stress.append(output)
...
def calculate_effective_vertical_normal_stress(s_p, data, i):
    ...
    # Top
    output[0] = data.vertical_normal_stress.list[i][0] - data.water_pressure.list[i][0]
    # Bottom
    output[1] = data.vertical_normal_stress.list[i][1] - data.water_pressure.list[i][1]
    # Add the output to the effective vertical normal stress list
    data.effective_vertical_normal_stress.append(output)
...
def calculate_effective_horizontal_stress(s_p, data, i):
    ...
    # Top
    output[0] = s_p.calculate_soil_pressure_coefficient(s_p.soil_layer_list[i].soil.angle) * data.effective_vertical_normal_stress.list[i][0]
    # Bottom
    output[1] = s_p.calculate_soil_pressure_coefficient(s_p.soil_layer_list[i].soil.angle) * data.effective_vertical_normal_stress.list[i][1]
    # Add the output to the effective horizontal normal stress list
    data.effective_horizontal_normal_stress.append(output)